...
data_obj_pattern = re.compile('^(record|applet|file|workflow|database|dbcluster)-[0-9A-Za-z]{24}$')
hash_pattern = re.compile('^(record|app|applet|workflow|globalworkflow|job|analysis|project|container|file|database|dbcluster)-[0-9A-Za-z]{24}$')
