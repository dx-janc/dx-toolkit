...
parser_find_data.add_argument('--class', dest='classname', choices=['record', 'file', 'applet', 'workflow', 'database', 'dbcluster', 'app', 'globalworkflow'],
    help='Data object class',
    metavar='{record,file,applet,workflow,database,dbcluster,app,globalworkflow}'
)
